...
import { X, MapPin, Clock, Calendar, Globe, Store, Building2 } from 'lucide-react'
    ...
    >
      ...
      >
        ...
        <div className="overflow-y-auto flex-1 p-5 flex flex-col gap-4" style={{ scrollbarWidth: 'thin' }}>
          ...
          {/* Horario */}
          {negocio.consultar_horarios && (
            <div className="flex items-center gap-2.5 text-sm text-gray-500 bg-gray-50 rounded-xl px-3.5 py-2.5">
              <Clock size={15} className="text-amber-400 shrink-0" />
              <span>Consultar horarios directamente con el negocio</span>
            </div>
          )}
          {!negocio.consultar_horarios && horarios.length > 0 && (
